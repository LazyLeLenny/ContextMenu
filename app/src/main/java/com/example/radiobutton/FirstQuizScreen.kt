...
class FirstQuizScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_first_quiz_screen)
        ...
        View.OnClickListener { view ->
            ...
            when(radioButton.id) {
                R.id.oneRB -> {
                    ...
                    startActivity(Intent(this, SecondQuizScreen::class.java)
                        .putExtra("resultOne", result))
                } else -> {
                result = 0
